    ...
    <form action={formAction} className="space-y-8">
      ...
      <div className="pt-4 border-t">
        ...
        <p className="mt-3 text-sm text-muted-foreground max-w-2xl">
          After you submit, FoodTruckCLT routes your request to relevant local trucks. Interested
          trucks can respond directly so you can compare options and book with them directly.
        </p>
      </div>
    </form>
  )
