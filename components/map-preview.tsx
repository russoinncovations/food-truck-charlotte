        ...
        <div className="mb-8 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
          <div className="max-w-3xl">
            ...
            <h2 className="mt-3 font-display text-3xl font-bold leading-tight tracking-tight text-primary-foreground md:text-4xl">
              See who&apos;s serving now
            </h2>
            <p className="mt-4 text-base leading-7 text-primary-foreground/75 md:text-lg md:leading-8">
              Check the live map when you want to find trucks open right now. Planning a private
              event?{" "}
              <Link href="/book-a-truck" className="font-medium text-primary-foreground underline-offset-4 hover:underline">
                Request a food truck
              </Link>{" "}
              instead — live mapping is discovery, not the booking path.
            </p>
          </div>
