      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto mb-12 max-w-2xl text-center md:mb-16">
          ...
          <p className="mt-4 text-base leading-7 text-muted-foreground md:text-lg">
            FoodTruckCLT is Charlotte&apos;s food truck request network, built from the city&apos;s
            largest food truck community. Reach the right local trucks, then work with them
            directly. No middleman. No booking commission.
          </p>
        </div>
